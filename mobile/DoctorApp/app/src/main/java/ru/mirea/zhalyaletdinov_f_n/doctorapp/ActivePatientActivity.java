...
import ru.mirea.zhalyaletdinov_f_n.doctorapp.databinding.ActivityActivePatientBinding;
...
public class ActivePatientActivity extends AppCompatActivity {
    ...
    private Button newTreatmentButton, archiveButton, treatmentChronoButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityActivePatientBinding.inflate(getLayoutInflater());
